...
export   MY_PROJECT_DIR=/gscratch/derakhti/shared/mleclair/dunex_model/missions/ 
...
#  export MY_ANALYTICAL_DIR=${MY_PROJECT_DIR}/ROMS/Functionals
  #  export     MY_HEADER_DIR=${MY_PROJECT_DIR}/compile/ROMS/include 
   export     MY_HEADER_DIR=${MY_PROJECT_DIR} # NOTE(@mleclair): This is where you find PROJECT_NAME.h
   export MY_ANALYTICAL_DIR=${MY_PROJECT_DIR}/compile/ROMS/functionals
